...
#
# Script generated by Vivado on Mon Feb 23 17:51:22 CET 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : YourGameName.sh
...
#
# Usage        : YourGameName.sh
#                YourGameName.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                YourGameName.sh [-rerun]
#                YourGameName.sh [-reset_run]
#                YourGameName.sh [-clean]
#                YourGameName.sh [-reset_log]
#                YourGameName.sh [-help]
#
...
export RDI_DATADIR="/tools/AMD/${SIM_VER_XSIM}/data"
...
# script info
echo -e "YourGameName.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./YourGameName.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot YourGameName xil_defaultlib.YourGameName xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim YourGameName -key {Behavioral:sim_1:Functional:YourGameName} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/tools/AMD/${SIM_VER_XSIM}/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb YourGameName.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./YourGameName.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: YourGameName.sh [-help]\n\
Usage: YourGameName.sh [-step]\n\
Usage: YourGameName.sh [-lib_map_path]\n\
Usage: YourGameName.sh [-rerun]\n\
Usage: YourGameName.sh [-reset_run]\n\
Usage: YourGameName.sh [-clean]\n\
Usage: YourGameName.sh [-reset_log]\n\
Usage: YourGameName.sh [-keep_index]\n\
Usage: YourGameName.sh [-noclean_files]\n\n\
